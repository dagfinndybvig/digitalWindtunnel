...
<br>The next step could be taking a look at XFOIL, a somewhat more modern Fortran-based airfoil analysi program: https://web.mit.edu/drela/Public/web/xfoil/
